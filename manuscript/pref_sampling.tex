...
\item Using simulation, we show that moderate levels of preferential sampling can lead to large (e.g. $40\%$) bias in estimates of animal density, and that our modeling approach can considerably reduce this bias.
