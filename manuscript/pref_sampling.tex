...
\item We apply our approach to aerial survey counts of bearded seals (\textit{Erignathus barbatus}) in the eastern Bering Sea. Models that included a preferential sampling effect led to lower estimates of abundance than models without, but were not favored by an integrated Akaike Information Criterion.  Importantly, the effect size of the preferential sampling parameter decreased in models that included explanatory environmental covariates.
